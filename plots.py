...
if __name__ == '__main__':
    ...
    # plot_bias_severity_impact("lp_data_cifar10_noise_severity.csv")
    # eval_sample_size_impact("lp_data_cifar10_noise.csv")
    # get_corrrelation_metrics("lp_data_cifar10_noise.csv")
    genfailure_metrics("lp_data_cifar10_noise.csv")
