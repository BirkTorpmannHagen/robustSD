...
from vae.utils import TryExcept, emojis
from vae.utils.downloads import gsutil_getsize
from vae.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from vae.utils.general import *; strip_optimizer()
