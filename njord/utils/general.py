...
from njord.utils import TryExcept, emojis
from njord.utils.downloads import gsutil_getsize
from njord.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from njord.utils.general import *; strip_optimizer()
